...
const STYLE = {
  notice_mask:
    "notice_mask fixed inset-0 z-70 flex w-screen items-start justify-center bg-black/50 backdrop-blur-sm",

  notice_content:
    "notice_content mt-20 flex w-[92vw] max-w-lg flex-col gap-4 rounded bg-black px-4 py-2 ring-2 ring-white/50",

  notice_text:
    "notice_text modal flex min-h-30 items-center justify-center border border-white/50 px-4",
};
  ...
  return (
    <section className={STYLE.notice_mask}>
      <Fade direction="up" duration={500}>
        <div ref={modalRef} className={STYLE.notice_content}>
